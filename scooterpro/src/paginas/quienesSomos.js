...
import bannerQuienessomos from "../assets/img/bannerQuienessomos.png";

const QuienesSomos = () => {
  return (
    <section>
      <div
        className="relative h-56 w-full bg-center bg-cover flex items-center justify-center overflow-hidden"
        style={{ backgroundImage: `url(${bannerQuienessomos})` }}
      >
